...
const sampleHoldings = [
  { _id: "1", symbol: "AAPL", name: "Apple Inc.", type: "stock", quantity: 50, avgBuyPrice: 175.5, currentPrice: 178.25, change24h: 1.25 },
  { _id: "2", symbol: "GOOGL", name: "Alphabet Inc.", type: "stock", quantity: 20, avgBuyPrice: 140.0, currentPrice: 142.8, change24h: 2.0 },
  { _id: "3", symbol: "MSFT", name: "Microsoft Corp.", type: "stock", quantity: 35, avgBuyPrice: 375.0, currentPrice: 378.5, change24h: 0.93 },
  { _id: "4", symbol: "BTC", name: "Bitcoin", type: "crypto", quantity: 0.5, avgBuyPrice: 45000, currentPrice: 48250, change24h: 3.2 },
  { _id: "5", symbol: "ETH", name: "Ethereum", type: "crypto", quantity: 3, avgBuyPrice: 2200, currentPrice: 2350, change24h: 2.8 },
];
...
export default function DashboardPage() {
  ...
  const totalValue = sampleHoldings.reduce((sum, h) => sum + h.quantity * h.currentPrice, 0);
  const totalCost = sampleHoldings.reduce((sum, h) => sum + h.quantity * h.avgBuyPrice, 0);
        ...
        <div className="p-6 bg-card rounded-lg border">
          ...
          <div className="space-y-4">
            <div>
              ...
              {holdings.filter((h) => h.change24h > 0).sort((a, b) => b.change24h - a.change24h).slice(0, 5).map((h) => (
            ...
            <div>
              ...
              {holdings.filter((h) => h.change24h < 0).sort((a, b) => a.change24h - b.change24h).slice(0, 5).map((h) => (
                <div key={h._id} className="flex justify-between text-sm">
                  <span>{h.symbol}</span>
